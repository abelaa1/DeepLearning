...
class KnowledgeDistillationArguments:
    teacher: Optional[str] = field(
        default="", metadata={"help": "teacher learner"}
    )

    student: Optional[str] = field(
        default="", metadata={"help": "student learner"}
    )

    train_loader: Optional[str] = field(
        default="", metadata={"help": "train loader"}
    )
    ...
    soft_target_loss_weight: int = field(
        default=0,
        metadata={
            "help": (
                "soft target"
